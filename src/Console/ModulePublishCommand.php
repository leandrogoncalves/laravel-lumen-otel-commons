...
namespace Picpay\LaravelAspect\Console;
...
{
    /** @var string */
    protected $name = 'picpay:aspect-module-publish';

    /** @var string */
    protected $description = 'Publish any aspect modules from picpay/laravel-aspect';
