...
class AspectClearCacheCommandTest extends \AspectTestCase
{
    ...
    /** @var \Picpay\LaravelAspect\Console\ClearCacheCommand */
    protected $command;
    ...
    protected function setUp(): void
    {
        ...
        $this->command = new \Picpay\LaravelAspect\Console\ClearCacheCommand(
            $this->app['config'],
            $this->app['files']
        );
    ...
    public function testCacheClearFile()
    {
        ...
        $configure = $this->app['config']->get('picpay-laravel-aop');
